...
import ServiceImpl.ChiTietSanPhamSerImpl;
...
public class sp extends javax.swing.JPanel {
    ...
    private DefaultComboBoxModel<DongSanPham> dtDSP = new DefaultComboBoxModel();
    ...
    private sanphamRp SanPhamService = new sanphamRp();
    ...
    List<DongSanPham> ListDSP = ctspsi.getAllDSP();
    ...
    public DongSanPham ShowDSP(String dsp) {
        for (int i = 0; i < ListDSP.size(); i++) {
            DongSanPham Dsp = (DongSanPham) cbbLoai.getItemAt(i);
    ...
    public DongSanPham filldsp(String dsp) {
        for (int i = 0; i < ListDSP.size(); i++) {
            DongSanPham dspp = (DongSanPham) cbbLoai.getItemAt(i);
...
//    private String anhSp;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        List<DongSanPham> ListDSP2 = dspImpl.getAll();
