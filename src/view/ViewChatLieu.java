...
public class ViewChatLieu extends javax.swing.JFrame {
    ...
    public ViewChatLieu() {
        ...
        list = new ArrayList<>();
        chatLieuSer = new ChatLieuImpl();
        list = chatLieuSer.getAll();
        loadData(list);
    }
    ...
    private void loadData(List<ChatLieu> listDongSP) {
        dtm.setRowCount(0);
        for (ChatLieu dongSP : listDongSP) {
    ...
    private void fill(int index) {
        ...
        txtMa.setText(chatLieu.getMaCL().toString());
        txtTen.setText(chatLieu.getTenCL().toString());
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm ?") == JOptionPane.YES_OPTION) {
            try {
                add();
                List<ChatLieu> list = chatLieuSer.getAll();
                loadData(list);
            } catch (Exception e) {
                e.printStackTrace();
            }
