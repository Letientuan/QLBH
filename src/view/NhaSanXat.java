 ...
 * @author Admin
 */
public class NhaSanXat extends javax.swing.JFrame {

    private DefaultTableModel dtm;
    private List<NhaSanXuat> list;
    private NSXRepository nsv;
    ...
    public void add() {
        try {
            if (check()) {
                ...
                sp.setTenNhaSanXuat(txtTen.getText());
                nsv.addSanPham(sp);
    ...
    private void loadData(List<NhaSanXuat> listDongSP) {
        dtm.setRowCount(0);
        for (NhaSanXuat dongSP : listDongSP) {
            dtm.addRow(dongSP.todataRow());
        }
    }

    private void fill(int index) {
        NhaSanXuat chatLieu = list.get(index);
        txtMa.setText(chatLieu.getManhaSanXuat().toString());
        txtTen.setText(chatLieu.getTenNhaSanXuat().toString());
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm ?") == JOptionPane.YES_OPTION) {
            try {
                add();
                List<NhaSanXuat> list = nsv.getAll();
                loadData(list);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhaSanXat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
